...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Texon — The Entertainment Network" },
      { name: "description", content: "Texon is a mobile-first platform to watch and create web series, short films, and stories. Upload, grow your audience, and earn." },
      { name: "author", content: "Texon" },
      { property: "og:title", content: "Texon — The Entertainment Network" },
      { property: "og:description", content: "Texon is a mobile-first platform to watch and create web series, short films, and stories. Upload, grow your audience, and earn." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Texon — The Entertainment Network" },
      { name: "twitter:description", content: "Texon is a mobile-first platform to watch and create web series, short films, and stories. Upload, grow your audience, and earn." },
